...
First, `par` which are initial values for the parameters to be optimzed over. These initial values are actually super important, and setting them close to your optimal values can be helpful. Here we'll generate parameters from the normal distribution, as that is how our data is distributed. 
...
p2 <- optim(par = ____, #our starting parameters
           ...
           ______, #passing our above data into the function
           ______)
