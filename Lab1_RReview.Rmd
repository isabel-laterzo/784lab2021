...
setwd() #in the parentheses, set the working directory to the folder where you save this file
#realistically, this isn't super relevant now because you're not reading in external data
...
# Math Review:
\
12. Let's try out some linear algebra. Below are 2 vectors, a and b, and two matrices A and B. Use them for this section.
```{r, include = TRUE}
#a
a <- c(4, -5, 4, 1)
#b
